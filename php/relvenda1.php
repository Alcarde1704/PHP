...
<body>
  <div class="container">
    <div class="titulo-relatorio">
      <form action="relvenda1.php" method="POST">
        <h2>Relátorio de vendas de produtos por data de compra</h2>
      ...
      <table>
        <tr>
          ...
          if (isset($_POST["botao"])) {
            ...
            require("conecta.php");
            $busca = $mysqli->query("select * from tb_vendas order by dtvenda");
