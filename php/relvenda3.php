...
<body>
  <div class="container">
    <div class="titulo-relatorio">
      <form action="relvenda3.php" method="POST">
        <h2>Relátorio total de vendas de produtos por cliente</h2>
        Nome: <input type="text" name="nomecli" size="50" maxlength="50">
      ...
      <table>
        <tr>
          ...
          if (isset($_POST["botao"])) {
            ...
            $busca = $mysqli->query("select * from tb_vendas where cliente like '%$nomecli%' order by valorpg");
